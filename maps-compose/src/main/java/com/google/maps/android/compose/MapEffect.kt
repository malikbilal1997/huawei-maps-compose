 ...
 * [HuaweiMap()] composable function. However, there are use cases when obtaining a raw reference to
 * the map is desirable for extensibility (e.g. using the utility library for clustering).
 */
@Composable
@HuaweiMapComposable
...
@HuaweiMapComposable
@MapsComposeExperimentalApi
public fun MapEffect(vararg keys: Any?, block: suspend CoroutineScope.(HuaweiMap) -> Unit) {
  val map = (currentComposer.applier as MapApplier).map
