 ...
 * [CameraPositionState] may only be used by a single [HuaweiMap] composable at a time as it
...
private constructor(position: CameraPosition = CameraPosition(LatLng(0.0, 0.0), 0f, 0f, 0f)) {
   ...
   *
   * If this [CameraPositionState] is not currently bound to a [HuaweiMap] this call will suspend
